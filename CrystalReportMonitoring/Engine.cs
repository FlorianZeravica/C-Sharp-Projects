...
namespace CrystalReportMonitoring
{
    public class Engine
    {
        //Get all directories except this one
        private const string excludingDirectory = "Archive";
        private const string secondExcludingDirectory = "Vorschau";

        public static string ExcludingDirectory
        {
            get
            {
                return excludingDirectory;
            }
        }
        ...
        public void Process(string path, string reportFileExtension, string fileName, string fileExtension)
        {
        ...
        public string[] GetSubdirectories(string path)
        {
            ...
            var allPaths = Directory.GetDirectories(path, "*", SearchOption.AllDirectories)
                           .Where(item => !item.Contains(ExcludingDirectory)).ToArray();
